...
def hsv_rgb(h, s, v):
    """Función que se encarga de transformar de hsv a rgb
        y tiene en cuenta que: 0 <= H <= 360, 0 <= s <= 1, 0 <= v <= 1"""
...
print(rgb_hsv(12,12,12))
print(hsv_rgb(212, 94, 78)) #(h, %, %)
print(rgb_hsl(160, 255, 50))
print(hsl_rgb(88, 1, 0.6))
print(rgb_cmy(80, 35, 98))
print(cmy_rgb(0.3529, 0.8039, 0.5294))
